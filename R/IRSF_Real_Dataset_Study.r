...
# Cumulative OOB Error Rate is between 0 and 1, and measures how well the predictor correctly ranks (classifies)
# random individuals in terms of event probability.
...
# TTX
#====
allX.rank.mdms <- rsf.rank(X=X[,c("TTX","EventX","Race","Group3","DEFB.CNV3","CCR2.SNP","CCR5.SNP2","CCR5.ORF","CXCL12.SNP2")],
...
# TTA
#====
allA.rank.mdms <- rsf.rank(X=X[,c("TTA","EventA","Race","Group3","DEFB.CNV3","CCR2.SNP","CCR5.SNP2","CCR5.ORF","CXCL12.SNP2")],
                           ntree=ntree, method="mdms", splitrule="logrank", importance="random", B=1000, ci=80,
                           parallel=TRUE, conf=conf, verbose=TRUE, seed=12345678)
...
#==========================================================================================#
allX.rank.cph <- cph.main(X=X[,c("TTX","EventX","Race","Group3","DEFB.CNV3","CCR2.SNP","CCR5.SNP2","CCR5.ORF","CXCL12.SNP2")], main.term=rownames(allX.rank.mdms))
allA.rank.cph <- cph.main(X=X[,c("TTA","EventA","Race","Group3","DEFB.CNV3","CCR2.SNP","CCR5.SNP2","CCR5.ORF","CXCL12.SNP2")], main.term=rownames(allA.rank.mdms))
